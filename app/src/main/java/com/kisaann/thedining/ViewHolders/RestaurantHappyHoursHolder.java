...
public class RestaurantHappyHoursHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    ...
    public RestaurantHappyHoursHolder(View itemView) {
        super(itemView);
